...
| D-003 | Customer authentication | Accepted 2026-08-10 | Product + security       | ADR 0023: progressive Supabase identity; guest → international phone OTP with +998 default; Google/Apple secondary; OneID deferred identity tier                                         |
