...
source and assign an existing or newly named topic. PDF pages are deterministically
converted to Markdown while JSON objects are deterministically converted to the extraction
